...
contextBridge.exposeInMainWorld('pt', {
  ...
  recordingSettings: () => ipcRenderer.invoke('recording-settings'),
  recordingSaveSettings: (settings) => ipcRenderer.invoke('recording-save-settings', { settings }),
  recordingChooseDirectory: () => ipcRenderer.invoke('recording-choose-directory'),
  recordingOpenDirectory: () => ipcRenderer.invoke('recording-open-directory'),
  recordingRevealLast: () => ipcRenderer.invoke('recording-reveal-last'),
  recordingPrepare: (payload) => ipcRenderer.invoke('recording-prepare', payload),
  recordingWriteChunk: (payload) => ipcRenderer.invoke('recording-write-chunk', payload),
  recordingFinish: (payload) => ipcRenderer.invoke('recording-finish', payload),
  recordingAbort: (payload) => ipcRenderer.invoke('recording-abort', payload),
